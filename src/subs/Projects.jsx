...
const projects =[
    ...
    {'name':'Form', 'skills': 'HTML CSS JS' ,'image':'./images/projects/contact-form.png', 'liveurl': 'https://tochukwu-1.github.io/Frontend-Mentor-Contact-form/', 'solutionurl': 'https://github.com/Tochukwu-1/Frontend-Mentor-Contact-form/'},
    ...
    {'name':'Weather App', 'skills': 'HTML CSS React' ,'image':'./images/projects/Weather-app.png', 'liveurl': 'https://teesconceptweatherapp.netlify.app/', 'solutionurl': 'https://github.com/Tochukwu-1/Weather-app'}
]
            ...
            <ul>
                ...
                <li>
                    <a href={project.liveurl} target='_blank'>
                        ...
                        <h2>{project.name}</h2>
                        <p>{project.skills}</p>
                    <p className="solution"><a href={project.solutionurl} target="_blank">Solution Url</a></p>
